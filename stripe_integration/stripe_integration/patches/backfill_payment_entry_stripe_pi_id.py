...
def execute():
    ...
    Payment Entries created before v2 introduced the field write on PE.
    Refund lookups join on `stripe_payment_intent_id`, so legacy rows
    without it cannot be matched to incoming Stripe refund events.
    """
